...
public:
        ...
        , _owner_id(generate_id<owner_t>())
    {
        ...
        if (_game_id)
        {
            ...
            Header initHeader(Communication::msg_header_t::CLIENT_JOIN_GAME, _owner_id, _game_id);
        ...
        else
        {
            ...
            Header initHeader(Communication::msg_header_t::CLIENT_CREATE_GAME, _owner_id, _game_id);
            Message initMessage(initHeader);
            write(initMessage);
        }
    }
