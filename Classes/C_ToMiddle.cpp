...
C_ToMiddle::C_ToMiddle(bool *announcement_ptr, Fields *field_announced_ptr, int *number_of_filled_columns)
...
bool C_ToMiddle::valid_order(Fields type_of_current) const{
     ...
     * ->Upper part fields can be filled if they wasn't filled previously and the above
     * field was filled previously
     * ->Bottom part fields can be filled if they wasn't filled previously and the lower
     * field was filled previously
